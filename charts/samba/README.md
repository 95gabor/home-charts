...
| image.digest | string | `"sha256:a789aa42c2e5db804fab5fb5dd5f2d4343a9a8a7789e4a191aab45e993c15d4f"` | Multi-arch digest for smbd-only-latest (takes precedence over tag/appVersion) |
